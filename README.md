Project Name: Customer Churn Prediction (Mid+ Project)
...
Business-Oriented Churn Scoring (WOW Part)
...
The focus is on real-world usability, not just model performance.
